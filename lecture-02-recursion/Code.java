...
public class Code{
    ...
    public static void printStr_cont_codes(String str, String asf){
        ...
        for(int i =0;i<code.length();i++){
            char chh = code.charAt(i);
            printStr_cont_codes(str.substring(1), asf+chh);
        }
    }
    ...
    public static int print_Permutation_withDuplicates(String str,String asf){
        ...
        for(int i = 0; i<str.length();i++){
            ...
            char ch = str.charAt(i); //  ek ek karke a , b, c nikal lo 
